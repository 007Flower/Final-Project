...
COPY Feeder
FROM '/home/dylan/Final-Project/Feeder.csv'
DELIMITER ','
CSV HEADER;

COPY Programs
FROM '/home/dylan/Final-Project/Programs.csv'
DELIMITER ','
CSV HEADER;

COPY Student_information
FROM '/home/dylan/Final-Project/Student_information.csv'
DELIMITER ','
CSV HEADER; 


COPY Courses
FROM '/home/dylan/Final-Project/Courses.csv'
DELIMITER ','
CSV HEADER;

COPY Semester
FROM '/home/dylan/Final-Project/Semester.csv'
DELIMITER ','
CSV HEADER;

COPY Semester_Courses
FROM '/home/dylan/Final-Project/Semester_Courses.csv'
DELIMITER ','
CSV HEADER;


--Overall acceptance rate for the BINT program
